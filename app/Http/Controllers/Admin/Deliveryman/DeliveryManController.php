...
class DeliveryManController extends Controller
{
    ...
    public function cashPayDeliveryMan(Request $request, $id, DeliveryManWalletRepository $deliveryManWalletRepo)
    {
        ...
        $wallet = $deliveryManWalletRepo->getFirstWhere(params: ['delivery_man_id' => $id]);
        ...
        return redirect(route('admin.delivery-man.earning-statement-overview', ['id' => $deliveryMan->id]));
    }
}
