...
<head>
    ...
    <link rel="shortcut icon"
        href="{{ dynamicStorage(path: 'storage/app/public/company') }}/{{ $web_config['fav_icon']->value }}" />
...
<body class="toolbar-enabled">
    ...
    @if ($google_tag_manager_id)
        <noscript>
            <iframe class="d-none visibility-hidden"
                src="https://www.googletagmanager.com/ns.html?id={{ $google_tag_manager_id }}" height="0"
                width="0"></iframe>
        </noscript>
    @endif
