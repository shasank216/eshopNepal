...
>>>>>>> f00d73d41e59bec24f249e3276b71673d32680db
                        ...
                        <div class="row items-container" id="ajax-products">
                            @if (count($products) > 0)
...
<<<<<<< HEAD
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card custom-card" style="border-radius: 0;">
                            ...
                            <!-- Image -->
                            <img src="{{ asset('storage/app/public/poster/' . $blog['image']) }}" class="card-img-top" alt="{{ $blog->title }}" style="border-radius: 0;">
                            <div class="card-body">
                                <span class="badge badge-light category-badge">{{ $blog->title }}</span>
                                <div class="card-text mt-auto">
                                    <h5 class="card-title" style="line-height: 44px;">{{ strip_tags($blog->details) }}</h5>
                                    <p class="card-subtitle">by {{ $blog->added_by }} {{ $blog->created_at->format('Y-m-d') }}</p>
                                </a> 
                                </div>
                            </div>
                            {{-- <a href="{{route('blogDetailsView',['id'=>$blog])}}" class="btn"
                                tabindex="-1">
                                Read More
