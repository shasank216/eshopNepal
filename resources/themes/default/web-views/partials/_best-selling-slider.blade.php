                                            ...
                                            <div class="carding position-relative">
                                                ...
                                                <div class="actions">
                                                    ...
                                                    <div class="compare-container">
                                                        ...
                                                        <div class="compare-checkbox mt-2 d-none"
                                                            ...
                                                            <label
                                                                for="compare-{{ $product->id }}">{{ translate('Add to Compare') }}</label>
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="details">
                                                ...
                                                <a href="{{ route('product', $product->slug) }}">
                                                    ...
                                                    <span
                                                        class="bold-title">{{ Str::limit($product['name'], 23) }}</span>
                                            ...
                                            <form id="add-to-cart-form" class="mb-2">
                                                ...
                                                <div class="__btn-grp d-none d-sm-flex">
                                                    ...
                                                    @if (
                                                        ...
                                                        <button class="btn add-to-cart string-limit w-100"
                                                            type="button" disabled>
                                                            {{ translate('add_to_cart') }}
                                                        </button>
                                                    @else
                                                        <button type="button" class="btn add-to-cart w-100 mx-3"
                                                            data-id="{{ $product->id }}">
                                                            <i class="navbar-tool-icon czi-cart me-2"></i>
                                                            <span
