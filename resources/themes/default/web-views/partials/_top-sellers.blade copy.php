                                        ...
                                        @if (
                                            $seller->shop->temporary_close ||
                                                ($seller->shop->vacation_status &&
                                                    $current_date >= $seller->shop->vacation_start_date &&
                                                    $current_date <= $seller->shop->vacation_end_date))
                                            <span
...
<script>
    if (!window.location.search.includes("lat=")) {
        navigator.geolocation.getCurrentPosition(function(position) {
            ...
            window.location.href = url.toString(); // refresh only once with location
        });
    }
</script>
