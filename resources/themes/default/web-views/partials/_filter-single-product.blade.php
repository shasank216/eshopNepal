            ...
            <div class="search-product-image">
                <div class="inline_product clickable d-flex justify-content-center">
                    ...
                    <div class="p-10px pb-0">
                        <a href="{{ route('product', $product->slug) }}" class="w-100 d-flex align-items-center justify-content-center">
                            <img alt=""
                                ...
                                @else
                                    ...
                                    @else
                                         <a href="{{ route('customer.auth.login') }}"
                                                ...
                                                <a href="{{ route('customer.auth.login') }}"
                                                   class="btn action-add-to-cart-form-re add-to-cart" data-product-id="{{ $product->id }}"
                                                    type="button"
