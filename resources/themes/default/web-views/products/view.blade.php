                                ...
                                @foreach ($categories as $category)
                                    <div class="checkbox-wrapper-48">
                                        <label class="d-flex align-items-center">
                                            ...
                                            <a href="{{ route('products', ['data_from' => 'category', 'id' => $category['id'], 'page' => 1]) }}"
                                                class="m-0 categories_text text-decoration-none text-dark">
                                                {{ $category['name'] }}
    ...
    <script>
        ...
        function reinitializeFunctionalities() {
            ...
            function addToCart(productId) {
                let variationCode = $(`#variation-code-${productId}`).val();
