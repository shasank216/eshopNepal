...
@section('content')
    ...
    <section class="compare-section">
        ...
        <div class="product-compare-section container" id="compare-products-container">
                                ...
                                <form id="add-to-cart-form" class="mb-2 px-2">
                                    ...
                                    <div class="__btn-grp mt-2 mb-3 d-none d-sm-flex">
                                        ...
                                        @else
                                            ...
                                            <button type="button" class="btn remove-from-compare" data-id="{{ $product->id }}" style="background-color: red; color: white;">
                                                <i class="fa fa-times text-white me-2"></i>
                                                <span class="string-limit text-white">Remove</span>
                                            </button> 
                                        @endif
...
@push('script')
    ...
    {{-- Remove from compare --}}
    <script>
        // Event handler for removing a product from the comparison list
