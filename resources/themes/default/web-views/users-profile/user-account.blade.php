                            ...
                            <form class="mt-3 px-sm-2 pb-2" action="{{ route('user-update') }}" method="post"
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        ...
                                        {{-- Only ONE input, and it MUST have a "name" --}}
                                        <input class="form-control phone-input-with-country-picker" id="phone"
                                            type="text" name="phone" value="{{ old('phone', $userCountryAndPhone) }}"
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        ...
                                        <select class="form-control" id="gender" name="gender">
                                            ...
                                            <option value="Male"
                                                {{ old('gender', $customerDetail['gender'] ?? '') == 'Male' ? 'selected' : '' }}>
                                                Male</option>
                                            <option value="Female"
                                                {{ old('gender', $customerDetail['gender'] ?? '') == 'Female' ? 'selected' : '' }}>
                                                Female</option>
                                            <option value="Others"
                                                {{ old('gender', $customerDetail['gender'] ?? '') == 'Others' ? 'selected' : '' }}>
                                                Others</option>
                                        </select>
                                    </div>
                                    <!-- added ends -->
