                                ...
                                <tr id="data-{{$banner->id}}">
                                    ...
                                    <td>
                                        <img class="ratio-4:1" width="80"
                                             ...
                                             src="{{asset('storage/app/public/poster')}}/{{$banner['image']}}">
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-10 justify-content-center">
                                            <a class="btn btn-outline--primary btn-sm cursor-pointer edit"
                                               ...
                                               href="{{route('admin.poster.edit',[$banner['id']])}}">
                                                <i class="tio-edit"></i>
                                            </a>
        ...
        $('.banner_status_form').on('submit', function(event){
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == 1) {
                        toastr.success('{{translate("poster_published_successfully")}}');
                    } else {
                        toastr.success('{{translate("poster_unpublished_successfully")}}');
                    }
                }
            });
        });
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            toastr.success('{{translate("poster_deleted_successfully")}}');
                            $('#data-' + id).hide();
                        }
                    });
                }
