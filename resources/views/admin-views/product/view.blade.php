                        ...
                        <div class="d-flex flex-column align-items-center __min-w-165px">
                            ...
                            @if ($productActive)
                                <a href="{{ route('product', $product['slug']) }}"
                                   class="btn btn-outline--primary mr-1 mt-2 textWhite" target="_blank">
                                    <i class="tio-globe"></i>
                                    {{ translate('view_live') }}
                                </a>
                            @endif
                                ...
                                <ul class="nav nav-tabs w-fit-content mb-2">
                                    @foreach($languages as $language)
                                        <li class="nav-item text-capitalize">
                                            <a class="nav-link lang-link textWhite {{$language == $defaultLanguage? 'active':''}}"
                                            href="javascript:"
                                        ...
                                        <div>
                                            @if($product['request_status'] == 0)
                                                <button class="btn btn-success p-2 px-3 update-status"
                                                   data-id="{{ $product['id'] }}"
                                                   data-redirect-route="{{route('admin.products.list',['seller', 'status' => $product['request_status']])}}"
                            ...
                            <div class="d-block mt-2">
                                @foreach($languages as $language)
                                    ...
                                    <div class="{{ $language != 'en'? 'd-none':''}} lang-form" id="{{ $language}}-form">
                                        <div class="d-flex">
                                            <h2 class="mb-2 pb-1 textWhite">{{ $translate[$language]['name']??$product['name']}}</h2>
                                        ...
                                        <div class="">
                                            <label class="textWhite font-weight-bold">{{ translate('description').' : ' }}</label>
