            ...
            <div class="col-lg-9">
                <form action="{{ route('vendor.profile.update', [$vendor->id]) }}" method="post"
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <label for="firstNameLabel" class="col-sm-3 col-form-label">{{ translate('full_Name') }}
                            ...
                            <div class="row">
                                <label for="phoneLabel" class="col-sm-3 col-form-label">{{ translate('phone') }} </label>
                            ...
                            <div class="row form-group">
                                <label for="newEmailLabel"
                                    class="col-sm-3 col-form-label">{{ translate('Vat / Pan Certificate') }}</label>

                                <div class="col-sm-4">
                                    <input type="file" class="form-control" name="vat_pan_img" id="newEmailLabel">
                                </div>
                                <div class="col-sm-4">
                                    <img id="viewer" class="avatar-img"
                                        src="{{ getValidImage(path: 'storage/app/public/vat_pan_img/' . $vendor->vat_pan_img, type: 'backend-profile') }}"
                                        alt="Image not found">
                                </div>
                            </div>
                            <div class="row form-group">
                                <label for="newEmailLabel"
                                    class="col-sm-3 col-form-label">{{ translate('Registration Certificate') }}</label>

                                <div class="col-sm-4">
                                    <input type="file" class="form-control" name="registration_cert_img"
                                        id="newEmailLabel">
                                </div>
                                <div class="col-sm-4">
                                    <img id="viewer" class="avatar-img"
                                        src="{{ getValidImage(path: 'storage/app/public/registration_cert_img/' . $vendor->registration_cert_img, type: 'backend-profile') }}"
                                        alt="Image not found">
                                </div>
                            </div>
                            <div class="row form-group">
                                <label for="newEmailLabel"
                                    class="col-sm-3 col-form-label">{{ translate('Citizenship Certificate') }}</label>

                                <div class="col-sm-4">
                                    <input type="file" class="form-control" name="citizenship_img"
                                        id="newEmailLabel">
                                </div>
                                <div class="col-sm-4">
                                    <img id="viewer" class="avatar-img"
                                        src="{{ getValidImage(path: 'storage/app/public/citizenship_img/' . $vendor->citizenship_img, type: 'backend-profile') }}"
                                        alt="Image not found">
                                </div>
                            </div>
                ...
                <div id="password-div" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        <form id="update-password-form"
                            ...
                            <div class="row form-group">
                                <label for="confirmNewPasswordLabel" class="col-sm-3 col-form-label pt-0">
