                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if (Helpers::module_permission_check('order_management'))
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/orders*') || Request::is('admin/refund-section*') ? 'active' : '' }}">
                        ...
                        @if (Helpers::module_permission_check('promotion_management'))
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/poster*')?'active':''}}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        ...
                                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                            ...
                                            <li
                                                class="nav-item {{ Request::is('admin/sellers/' . Vendor::LIST[URI]) || Request::is('admin/sellers/' . Vendor::VIEW[URI] . '*') ? 'active' : '' }}">
                                            ...
                                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                                ...
                                                <li
                                                    ...
                                                    <a class="nav-link" href="{{ route('admin.employee.list') }}"
                                                        ...
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span
                                                            class="text-truncate">{{ translate('employees') }}</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
